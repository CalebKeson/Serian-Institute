...
const Expenses = () => {
  ...
  const confirmDelete = async () => {
    if (deleteConfirm) {
      const result = await deleteExpense(deleteConfirm._id);
      if (result.success) {
  ...
  const handleExport = () => {
    ...
    const headers = ['Date', 'Expense #', 'Vendor', 'Description', 'Total', 'Status'];
  ...
  const getPageDescription = () => {
    if (reportView) {
      return 'Analyze and review expense reports across the institution';
    }
    return 'Track and manage all institutional expenses';
  };
  ...
  return (
    <Layout>
      <div className="max-w-7xl mx-auto">
            ...
            <div>
              ...
              {reportView && (
                <div className="mt-2 flex items-center space-x-2">
                  <span className="text-xs text-gray-500">Viewing report mode</span>
                  <button
            ...
            <div className="mt-4 sm:mt-0 flex space-x-3">
              ...
              {!reportView && (
                <button
                  ...
                  className="inline-flex items-center px-4 py-2 border border-transparent rounded-lg text-sm font-medium text-white bg-gradient-to-r from-red-600 to-orange-700 hover:from-red-700 hover:to-orange-800 transition-all shadow-sm hover:shadow-md"
                >
        ...
        {/* Summary Cards */}
        <ExpenseSummaryCards stats={expenseStats} loading={loading} />
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 mb-6">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-3 sm:space-y-0">
            <div className="relative flex-1 max-w-md">
              ...
              <input
                type="text"
                placeholder="Search by expense number, vendor, or description..."
                value={searchTerm}
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div>
                  ...
                  >
                    ...
                    {/* Categories will be populated from store */}
                  </select>
                </div>
        ...
        {pagination.total > 1 && (
          <div className="mt-6 flex items-center justify-between">
            <div className="text-sm text-gray-700">
              Showing page {pagination.current} of {pagination.total} ({pagination.results} total expenses)
            </div>
            <div className="flex space-x-2">
              <button
                ...
                <div className="mt-3 text-center">
                  ...
                  <div className="mt-2">
                    <p className="text-sm text-gray-500">
                      ...
                      <span className="font-semibold">{deleteConfirm.expenseNumber}</span>?
                    </p>
                    {deleteConfirm.status === 'paid' && (
                      <p className="text-sm text-red-500 mt-2">
                        ⚠️ Warning: This expense has already been paid. 
                        Deleting it may affect financial records.
                      </p>
                    )}
                  </div>
                </div>
