...
const AddExpense = () => {
  ...
  const { createExpense, loading, fetchExpense } = useExpenseStore(); // Add fetchExpense
  const { expenseCategories, fetchExpenseCategories } = useExpenseStore();
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const submissionData = {
        ...
        items: formData.items.map(({ tempId, ...item }) => ({
      ...
      if (result.success) {
        ...
        // CRITICAL FIX: Navigate with a state flag to force refresh
        // This tells the ExpenseDetails component to fetch fresh data
        navigate(`/expenses/${result.data._id}`, { 
          state: { refresh: true, newExpenseId: result.data._id }
        });
      }
    } catch (error) {
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="mt-2 text-gray-600">
                  Record a new expense with breakdown items
                </p>
              </div>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-8">
              ...
              <div className="mt-4 p-4 bg-gray-50 rounded-lg border border-gray-200">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-2xl font-bold text-red-600">
                    {new Intl.NumberFormat('en-KE', { style: 'currency', currency: 'KES' }).format(totalAmount)}
                  </span>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                onChange={handleChange}
                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 transition-colors"
            ...
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
              <div className="flex items-start">
                ...
                <div>
                  <h4 className="text-sm font-medium text-yellow-800">Draft Status</h4>
                  <p className="text-sm text-yellow-700 mt-1">
                    This expense will be saved as a draft. You can submit for approval later.
